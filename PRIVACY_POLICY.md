...
This privacy policy applies to the Scroll Block app (hereby referred to as "Application") for mobile devices that was created by ECHOO (hereby referred to as "Service Provider") as an Open Source service. This service is intended for use "AS IS".
